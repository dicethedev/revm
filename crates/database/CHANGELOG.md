...
## [16.0.0](https://github.com/dicethedev/revm/compare/revm-database-v15.0.2...revm-database-v16.0.0) - 2026-06-06

### Added

- *(database)* add conditional bundle update builder ([#3729](https://github.com/dicethedev/revm/pull/3729))

### Other

- avoid reallocations and cloning during commit ([#3732](https://github.com/dicethedev/revm/pull/3732))
